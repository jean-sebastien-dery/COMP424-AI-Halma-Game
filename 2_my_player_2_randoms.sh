...
gnome-terminal --title="Player 1" -x java -cp ./jar/projectsrc.jar boardgame.Client halma.CCRandomPlayer localhost 8123
echo "Starting the third player.";
gnome-terminal --title="Player 2" -x java -cp ./jar/projectsrc.jar boardgame.Client halma.CCRandomPlayer localhost 8123
echo "Starting the fourth player.";
gnome-terminal --title="Player 3" -x java -cp ./jar/projectsrc.jar:/home/jdery/workspace/PrjAIProject/bin/ boardgame.Client s260430688.myPlayer1 localhost 8123
